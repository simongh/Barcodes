...
namespace Barcodes
{
	...
	public class Pattern
	{
		...
		//internal IEnumerable<Rectangle> Paint(BarcodeSettings settings)
		//{
		//    List<Rectangle> result = new List<Rectangle>();

		//    float offset = (settings.MediumHeight - settings.ShortHeight);
		//    float left = 0;
		//    Rectangle rect;
		//    foreach (Elements item in _State)
		//    {
		...
		//                rect = new RectangleF(left, 0, settings.WideWidth, settings.BarHeight)
