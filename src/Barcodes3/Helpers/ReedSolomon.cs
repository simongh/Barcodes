...
namespace Barcodes.Helpers
{
	...
	public class ReedSolomon
	{
		...
		private IReedSolomonInitialiser _Initialiser;
		private Collections.CoefficientsCollection _Coefficients;

		public ReedSolomon(IReedSolomonInitialiser initialiser)
		{
			if (initialiser == null)
			...
			InitaliseLogTables();
			_Coefficients = new Collections.CoefficientsCollection();
		}
